...
public class FCM {
    ...
    static public void send_FCM_Notification(final String tokenId, final String title, final String message){
...
//URL problem
    ...
    static public void send_FCM_NotificationMulti(final List<String> putIds2, final String tokenId, final String title,
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    //URL problem
                    System.out.println("Reading URL, Error occurred while sending push Notification!.." + mlfexception.getCause());
